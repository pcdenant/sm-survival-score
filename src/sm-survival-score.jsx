...
const QUESTIONS = [
  ...
  { dimension: "proof", text: "Quand tu proposes un changement à l'équipe ou au management, tu t'appuies sur quoi ?", answers: [{ text: "Un chiffre ou un fait — j'aurais pu me défendre si on m'avait poussé", score: 2 }, { text: "Une bonne raison, mais rien à montrer si on avait insisté", score: 1 }, { text: "Ça dépend, souvent j'ai juste un feeling", score: 0 }] },
  ...
  { dimension: "autonomy", text: "Qui facilite les événements Scrum quand tu n'es pas là ?", answers: [{ text: "Oui — et cette personne l'a déjà fait sans moi", score: 2 }, { text: "J'ai commencé, mais c'est pas encore ancré", score: 1 }, { text: "Personne, ils sont annulés ou reportés", score: 0 }] },
  ...
  { dimension: "strategic", text: "As-tu déjà entendu ton manager te présenter à quelqu'un (un directeur, un collègue, un nouveau) ? Comment il a décrit ton rôle ?", answers: [{ text: "Il citerait des résultats concrets ou des risques que tu as évités", score: 2 }, { text: "En restant vague : \"il s'occupe de l'agilité dans l'équipe\"", score: 1 }, { text: "Il décrirait ton rôle — facilitation, cérémonies Scrum — sans l'accrocher à aucun résultat", score: 0 }] },
  ...
  { dimension: "strategic", text: "Si ton entreprise annonçait une réduction de coûts demain, comment tu classerais le risque pour ton poste ?", answers: [{ text: "On mesurerait une perte concrète — une livraison ralentie, un risque non géré", score: 2 }, { text: "On sentirait un vide, mais personne ne pourrait le chiffrer", score: 1 }, { text: "Élevé — je serais probablement sur la liste", score: 0 }] },
];
